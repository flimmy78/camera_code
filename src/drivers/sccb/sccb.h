...
#define SCL_OUT   GPIO_DDR_1bit(PORTC,7,1)      //SCL-PA0设置为输出端口
#define SDA_OUT   GPIO_DDR_1bit(PORTC,8,1)      //SDA-PA1设置为输出端口
#define SDA_IN    GPIO_DDR_1bit(PORTC,8,0)      //SDA-PA1设置为输入端口

//--GPIO_SET_1bit(PORTx,n,data)--//
#define SCL_HIGH  GPIO_SET_1bit(PORTC,7,1)
#define SCL_LOW   GPIO_SET_1bit(PORTC,7,0)
#define SDA_HIGH  GPIO_SET_1bit(PORTC,8,1)
#define SDA_LOW   GPIO_SET_1bit(PORTC,8,0)
#define SDA_DATA  GPIO_GET_1bit(PORTC,8) 
